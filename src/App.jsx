...
function App() {
  ...
  function getPrevMonthLink(mm, yy) {
    ...
    return '<a class="prev-month" data-yy="' + yy1 + '" data-mm="' + mm1 + '" href="#">◀︎</a>';
  }

  function getNextMonthLink(mm, yy) {
    var mm1 = mm < 12 ? mm + 1 : 1;
    var yy1 = mm < 12 ? yy : yy + 1;
    return '<a class="next-month" data-yy="' + yy1 + '" data-mm="' + mm1 + '" href="#">▶︎</a>';
  }
  ...
  function printHead(mm, yy) {
    ...
    res += '<tr class="t-head" >\n';
    res += '  <td colspan="2" class="navi-l">' + getPrevMonthLink(mm, yy) + '</td>\n';
  ...
  useEffect(() => {
    ...
    window.addEventListener('click', function (e) {
      const mm = +e.target.dataset.mm;
      const yy = +e.target.dataset.yy;
  ...
  return (
    <div>
      ...
      <div className="wrapper-block">
        <div className="block-today" />
        <p className="text">Today</p>
      </div>
      <div className="wrapper-block">
        <div className="block-holiday" />
        <p className="text">Holiday</p>
      </div>
    </div>
  )
}
